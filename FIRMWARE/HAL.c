...
{
	imu->accel_utr = (int16_t)i2c_read(0x2A) | ((int16_t)i2c_read(0x2B) << 8);
	imu->accel_sac = (int16_t)i2c_read(0x28) | ((int16_t)i2c_read(0x29) << 8);
	imu->gyro_ant = (int16_t)i2c_read(0x17) | ((int16_t)i2c_read(0x16) << 8);
	imu->gyro_lat = (int16_t)i2c_read(0x19) | ((int16_t)i2c_read(0x18) << 8);
	imu->gyro_pos = (int16_t)i2c_read(0x15) | ((int16_t)i2c_read(0x14) << 8);
}
